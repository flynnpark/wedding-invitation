...
interface AllContentsPostCardProps {
  post: Post;
  handleOpenEditForm: (post: Post) => void;
  handleOpenDeleteForm: (post: Post) => void;
}
    ...
    <div className="text-left text-sm break-all leading-5">
      <div className="flex flex-row justify-between items-center mt-8">
        ...
        <div className="space-x-2">
          <button onClick={() => handleOpenEditForm(post)}>
            <svg
          ...
          <button onClick={() => handleOpenDeleteForm(post)}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
...
export default AllContentsPostCard;
