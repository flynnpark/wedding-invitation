...
function Home() {
  return (
    <Section>
      <div className="block items-center justify-center  max-w-xl mx-auto w-full relative my-20">
        <div className="absolute left-1/2 top-28 text-center -translate-x-1/2">
          ...
          <span className="text-gray-900 font-medium bg-white bg-opacity-70 py-2 px-4 text-3xl inline-block mt-2">
